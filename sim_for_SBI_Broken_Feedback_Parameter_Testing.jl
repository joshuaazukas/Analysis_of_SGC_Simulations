...
p = (kOn => 0.0042*60*60, kOff => 0.042*60*60,  kTr => 375, kTl => 310, dM => 1, dG => 0.00365) #parameter set for NO FEEDBACK Circuit
ukOn = Normal(0.0042*60*60,0.2*0.0042*60*60) # standard deviation raised to 20%. estimated from Suter et al. paper that used/measured kon and koff values (no reported standard deviation)
ukOff = Normal(0.042*60*60,0.2*0.042*60*60)
ukTr = Normal(375,125)
