...
stds = sheet[2:end, 2]  # Get values from column 2 (std)
...
function sample_cond_dist_std_noise(u, stds, x_fixed; cap_value=77)
    ...
    data = hcat(u, stds)  # Combine u and std as a 2D array
    kde_result = kde(data)
...
plot();
dir_path = "C:/Users/Strey Lab/Documents/GitHub/Analysis_of_SGC_Simulations/VaryAct_10/"
...
@time for i in 1:25
    ...
    k2n = var(GFPN)
    k3n = mean((GFPN.-k1).^3)
    k4n = mean((GFPN.-k1).^4) .- 3*k2n^2
    k5n = mean((GFPN.-k1).^5) - 10*k3n*k2n
...
jldsave("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VaryAct_10/noise_2kTr_10_sim_GFP.jld2"; sim_GFP_v) # save traces w/o noise
jldsave("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VaryAct_10/noise_2kTr_10_sinm_GFP.jld2"; simn_GFP_v) # save traces w noise added
...
jldsave("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VaryAct_9/noise_2kTr_9.jld2"; sim_sumstats,simn_sumstats,params) # save simulation summary stats w/o noise, w noise, and parameters for each trace
