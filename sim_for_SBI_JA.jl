...
# p = (kOn => 0.00042*60*60, kOff => 0.0042*60*60, kteton => 0, ktetoff => 0, kTr => 375, kTl => 310, dM => 1, dG => 0.00365) #parameter set for NO FEEDBACK Circuit
ukOn = Normal(0.00042*60*60,0.1*0.00042*60*60)
ukOff = Normal(0.0042*60*60,0.1*0.0042*60*60)
ukteton = Normal(0.0001016273663,0.000012)
uktetoff = Normal(54,7.2)
ukTr = Normal(375,125)
ukTl = Normal(310,265)
...
plot(sol, idxs=6, label="TetR",xlims=(0,2000))
