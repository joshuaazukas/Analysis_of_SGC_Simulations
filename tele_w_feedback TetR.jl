...
@parameters kOn, kOff, kteton, ktetoff, kTr, kTl, tOn, tOff, dM, dG, a;
@variables t;
...
p = (kOn =>0.0042*60*60, kOff => 0.00038*60*60, kteton => kTr => 25, kTl => 12, tOn => 100, tOff => 0.01*(dox), dM => 0.12, dG => 0.01);
