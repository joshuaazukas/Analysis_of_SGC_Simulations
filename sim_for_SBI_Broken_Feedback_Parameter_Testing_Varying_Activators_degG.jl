...
p = (kOn => 0.00033*60*60, kOff => 0.00066*60*60,  kTr => 50, kTrOn => 0.00025*60*60, kTrOff => 0.00033*60*60, kTrF => 625, kTl => 475, dM => 1.00, dG => 0.00365) 
param_string = join(["$key:$(round(value, digits=2))" for (key, value) in p], ", ")#parameter set for NO FEEDBACK Circuit
ukOn = Normal(0.000066*60*60,0.5*0.000066*60*60) # standard deviation raised to 20%. estimated from Suter et al. paper that used/measured kon and koff values (no reported standard deviation)
ukOff = Normal(0.000066*60*60,0.5*0.000066*60*60)
ukTrOn = Normal(0.00033*60*60,0.5*0.00033*60*60)
ukTrOff = Normal(0.00033*60*60, 0.5*0.00033*60*60)
udG = Normal(0.00365,0.00126);
#ukTr = Normal(310,150)
# calculate gamma distribution for kTL with mean=310 and std=265
g_scale = 150^2/475  #adjusted from 265^2/500
g_shape = 475/g_scale
...
kTrF_g_scale = 110^2/625
kTrF_g_shape = 625/kTrF_g_scale
...
plot();
dir_path = "C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VaryAct_7/"
...
jldsave("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VaryAct_6/noise_2kTr_6.jld2"; sim_sumstats,simn_sumstats,params)
