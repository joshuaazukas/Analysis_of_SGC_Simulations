...
@parameters kOn, kOff, kteton, ktetoff, kTr, kTrOn, kTrOff, kTrBOff, kTrF, kTl, dM, dG;
@variables t;
...
p = (kOn => 0.000165*60*60, kOff => 0.0001*60*60,  kTr => 100, kTrOn => 0.0033*60*60, kTrOff => 0.001*60*60, kTrBOff => 0.0001*60*60, kTrF => 500, kTl => 425, dM => 1.25, dG => 0.00365) 
#p = (kOn => 0.000165*60*60, kOff => 0.00033*60*60,  kTr => 50, kTrOn => 0.001*60*60, kTrOff => 0.00033*60*60, kTrBOff => 0.000066*60*60, kTrF => 500, kTl => 425, dM => 1, dG => 0.00365) 
param_string = join(["$key:$(round(value, digits=2))" for (key, value) in p], ", ");#parameter set for NO FEEDBACK Circuit
ukOn = Normal(0.000165*60*60,0.2*0.000165*60*60) # standard deviation raised to 20%. estimated from Suter et al. paper that used/measured kon and koff values (no reported standard deviation)
ukOff = Normal(0.0001*60*60,0.2*0.0001*60*60)
ukTrOn = Normal(0.0033*60*60,0.2*0.0033*60*60)
ukTrOff = Normal(0.001*60*60, 0.2*0.001*60*60)
ukTrBOff = Normal(0.0001*60*60, 0.2*0.0001*60*60)
#ukTr = Normal(310,150)
# calculate gamma distribution for kTL with mean=310 and std=265

#kTrOn_g_scale = 1/0.001*60*60
#kTrOn_g_shape = /g_scale
...
kTr_g_scale = 70^2/110
kTr_g_shape =110/kTr_g_scale
...
for i in 1:1000
    ...
    kTrOffBOff_new = rand(ukTrBOff)
    push!(dist_kTrBOff, kTrOffBOff_new)
    #kTr_new = rand(ukTr)
...
histogram(dist_kTrOn,bins=200,label="kTrOn")
histogram(dist_kTrOff,bins=200,label="kTrOff")
histogram(dist_kTrBOff,bins=200,label="kTrBOff")
...
for i in 1:1000
    ...
    kTr_new = bounded_sample(ukTrg,200, 0)
    kTrF_new = bounded_sample(ukTrFg,700, 250)
...
rxs = [
    ...
    (@reaction kTrOn, DNAon + B --> DNAonF),
    (@reaction kTrOff, DNAonF --> DNAon + B),
    (@reaction kTrBOff, DNAonF --> DNAoff + A + B),
...
@named rn = ReactionSystem(rxs, t, [A, B, DNAoff, DNAon, DNAonF, RNA, GFP], [kOn, kOff, kTr, kTrOn, kTrOff, kTrBOff, kTrF, kTl, dM, dG]);
rn = complete(rn);
...
@time for i in 1:1750
    ...
    pw = welch_pgram(GFP)
    ps = pw.power[2:11]
    params = [kOn_new, kOff_new, kTrOn_new, kTr_new, kTrOff_new, kTrOff_new, kTrBOff_new, kTrBOff_new, kTrF_new, kTl_new]
...
jldsave("noise_2kTr_3.jld2"; sim_sumstats,simn_sumstats,params)
...
BFC_GFP = XLSX.readxlsx("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/Broken Feedback Circuit Time Traces 5_21_24 GFP.xlsx");
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/SlopeHistExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/MeanHistExp_vs_Sim_Broken.png")
# Variance
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/VarHistExp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,3]), minimum(ex_sumstats[:,3]))
max_edge = max(maximum(simn_sumstats[:,3]), maximum(ex_sumstats[:,3]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,3], color=:red, normalize=:probability,  bins=bin_edges, alpha=0.5, label="Exp Temp Vars")
histogram!(simn_sumstats[:,3], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim Temp Vars", ylabel="Probability", xlabel="Temporal Variance of GFP # (10^6)",ylim=(0,0.125),xlim=(0,20))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/VarzHistExp_vs_Sim_Broken.png")
# CV
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/CVExp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,17]), minimum(ex_sumstats[:,17]))
max_edge = max(maximum(simn_sumstats[:,17]), maximum(ex_sumstats[:,17]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,17], color=:red, normalize=:probability,  bins=200, alpha=0.5, label="Exp Temp CV")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/CVzExp_vs_Sim_Broken.png")
#k3 - skewness
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/SkewExp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,4]), minimum(ex_sumstats[:,4]))
max_edge = max(maximum(simn_sumstats[:,4]), maximum(ex_sumstats[:,4]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,4], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k3")
histogram!(simn_sumstats[:,4], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k3", ylabel="Probability", xlabel="k3", ylim=(0,0.20), xlim=(-30,50))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/SkewzExp_vs_Sim_Broken.png")
#k4 - Kurtosis
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/KurtExp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,5]), minimum(ex_sumstats[:,5]))
max_edge = max(maximum(simn_sumstats[:,5]), maximum(ex_sumstats[:,5]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,5],  color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k4")
histogram!(simn_sumstats[:,5], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k4", ylabel="Probability", xlabel="k4", ylim=(0,0.20), xlim=(-500,250))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/KurtzExp_vs_Sim_Broken.png")
#k5
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/K5Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,6]), minimum(ex_sumstats[:,6]))
max_edge = max(maximum(simn_sumstats[:,6]), maximum(ex_sumstats[:,6]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,6],  color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k5")
histogram!(simn_sumstats[:,6], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k5", ylabel="Probability", xlabel="k5", ylim=(0,0.20),xlim=(-10000,5000))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/K5zExp_vs_Sim_Broken.png")
#power spectrum
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS1Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,7]), minimum(ex_sumstats[:,7]))
max_edge = max(maximum(simn_sumstats[:,7]), maximum(ex_sumstats[:,7]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,7], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k6")
histogram!(simn_sumstats[:,7], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k6", ylabel="Probability", xlabel="k6", ylim=(0,0.085),xlim=(0,10))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS1zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS2Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,8]), minimum(ex_sumstats[:,8]))
max_edge = max(maximum(simn_sumstats[:,8]), maximum(ex_sumstats[:,8]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,8], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k7")
histogram!(simn_sumstats[:,8], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k7", ylabel="Probability", xlabel="k7", ylim=(0,0.1),xlim=(0,3))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS2zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS3Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,9]), minimum(ex_sumstats[:,9]))
max_edge = max(maximum(simn_sumstats[:,9]), maximum(ex_sumstats[:,9]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,9], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k8")
histogram!(simn_sumstats[:,9], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k8", ylabel="Probability", xlabel="k8", ylim=(0,0.1),xlim=(0,2.25))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS3zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS4Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,10]), minimum(ex_sumstats[:,10]))
max_edge = max(maximum(simn_sumstats[:,10]), maximum(ex_sumstats[:,10]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,10], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k9")
histogram!(simn_sumstats[:,10], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k9", ylabel="Probability", xlabel="k9", ylim=(0,0.1),xlim=(0,1.75))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS4zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS5Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,11]), minimum(ex_sumstats[:,11]))
max_edge = max(maximum(simn_sumstats[:,11]), maximum(ex_sumstats[:,11]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,11], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k10")
histogram!(simn_sumstats[:,11], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k10", ylabel="Probability", xlabel="k10", ylim=(0,0.1),xlim=(0,1.75))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS5zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS6Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,12]), minimum(ex_sumstats[:,12]))
max_edge = max(maximum(simn_sumstats[:,12]), maximum(ex_sumstats[:,12]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,12], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k11")
histogram!(simn_sumstats[:,12], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k11", ylabel="Probability", xlabel="k11", ylim=(0,0.225),xlim=(0,3))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS6zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS7Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,13]), minimum(ex_sumstats[:,13]))
max_edge = max(maximum(simn_sumstats[:,13]), maximum(ex_sumstats[:,13]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,13], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k12")
histogram!(simn_sumstats[:,13], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k12", ylabel="Probability", xlabel="k12", ylim=(0,0.175),xlim=(0,1.25))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS7zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS8Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,14]), minimum(ex_sumstats[:,14]))
max_edge = max(maximum(simn_sumstats[:,14]), maximum(ex_sumstats[:,14]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,14], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k13")
histogram!(simn_sumstats[:,14], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k13", ylabel="Probability", xlabel="k13", ylim=(0,0.175),xlim=(0,1.25))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS8zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS9Exp_vs_Sim_Broken.png")
min_edge = min(minimum(simn_sumstats[:,15]), minimum(ex_sumstats[:,15]))
max_edge = max(maximum(simn_sumstats[:,15]), maximum(ex_sumstats[:,15]))
bin_edges = range(min_edge, max_edge, length=bins)
histogram(ex_sumstats[:,15], color=:red, normalize=:probability, bins=bin_edges, alpha=0.5, label="Exp k14")
histogram!(simn_sumstats[:,15], color=:grey, normalize=:probability, bins=bin_edges, alpha=0.5, label="Sim k14", ylabel="Probability", xlabel="k14", ylim=(0,0.185),xlim=(0,1.85))
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS9zExp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS10Exp_vs_Sim_Broken.png")
...
savefig("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/VariablekTr_2/PS10zExp_vs_Sim_Broken.png")