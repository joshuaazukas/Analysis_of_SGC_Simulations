...
uRNA = p.kOn1/(p.kOn1+p.kOff1)*p.kTr/p.dM
uGFP = uRNA*p.kTl/p.dG
u0 = [0, 0, uRNA, uGFP]
oprob = ODEProblem(f!, u0, tspan, p)
joprob = JumpProblem(oprob, Direct(), crj1, crj2)
...
plot();
dir_path = "C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/2_Tr_3/" #path to save data and figures
...
jldsave("C:/Users/jsazu/Documents/GitHub/Analysis_of_SGC_Simulations/StreyCats/Broken Feedback Circuit/2_Tr_3/2_Tr_3_2.jld2"; sim_sumstats,simn_sumstats,params)
...
savefig(joinpath(dir_path, "kdG.png"))
